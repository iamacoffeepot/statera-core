...
library FixedPointMathLibrary {
    ...
    // @notice Sourced from Remco Bloemen under the MIT license: https://xn--2-umb.com/22/exp-ln/
    ...
    // @notice Sourced from Remco Bloemen under the MIT license: https://xn--2-umb.com/22/exp-ln/
    function log(int256 x) private pure returns (int256 result) {
        unchecked {
            ...
            result *= 1677202110996718588342820967067443963516166;
            // add ln(2) * k * 5e18 * 2**192
            result += 16597577552685614221487285958193947469193820559219878177908093499208371 * k;
            // add ln(2**96 / 10**18) * 5e18 * 2**192
            result += 600920179829731861736702779321621459595472258049074101567377883020018308;
    ...
    // @notice Sourced from Remco Bloemen under the MIT license: https://xn--2-umb.com/22/exp-ln/
    function log2(uint256 x) private pure returns (uint256 result) {
        assembly {
